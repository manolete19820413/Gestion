...
CREATE TABLE `aplicaciones` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `FK_APLI_MODI_P_idx` (`modificado_por`),
  CONSTRAINT `FK_APLI_MODI_P` FOREIGN KEY (`modificado_por`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `aplicaciones` VALUES ('APP1','Aplicacion de prueba','2016-08-23 16:15:33','ADMIN');
...
-- Dump completed on 2016-08-25 16:05:44
